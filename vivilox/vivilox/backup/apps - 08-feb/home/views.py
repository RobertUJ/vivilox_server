...
# Models import
from vivilox.apps.contests.models import contest,category as cat_contest
from vivilox.apps.store.models import item,category as cat_store
...
def index_view(request):
	...
	ctx = {'objContest': _objContest,'objCont_feature':_objContest, 'objStore':_objStore,'objCat':_objCat}
